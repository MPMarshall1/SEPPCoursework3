...
public class EventPerformanceController extends Controller {
    ...
    // =========================================================================
    // Use case: Add Performance
    // =========================================================================

    /**
     * Allows the currently logged-in entertainment provider to add a new
     * performance to one of their existing events.
     *
     * @return the newly created {@link Performance}, or {@code null} if the
    ...
    /**
     * Allows the currently logged-in student to book tickets for an active
     * performance.  Ticketed performances require a successful payment; free
     * (non-ticketed) performances are booked without payment.
     *
     * @return the created {@link Booking}, or {@code null} if booking fails
     */
    ...
    /**
     * Allows the currently logged-in student to cancel one of their active
     * bookings.  For ticketed events a refund is processed automatically.
     */
    ...
    /**
     * Allows the currently logged-in student to leave a rating and written
     * comment for a performance they have attended (i.e. have/had an active
     * booking for).
     */
